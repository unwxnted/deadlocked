...
const FIRASANS_ICONS: &[u8] = include_bytes!("../resources/FiraSansIcons.ttf");
const CS2_ICONS: &[u8] = include_bytes!("../resources/CS2EquipmentIcons.ttf");
...
impl Font {
    ...
    fn register(ctx: &egui::Context, primary: &str) {
        ...
        font_defs.font_data.insert(
            String::from("fira_sans_icons"),
            Arc::new(FontData::from_static(FIRASANS_ICONS)),
        );
        font_defs.font_data.insert(
        ...
        proportional.push(String::from("fira_sans_icons"));
        ...
        let monospace = font_defs
            ...
            .unwrap();
        monospace.insert(0, String::from("cs2_icons"));
